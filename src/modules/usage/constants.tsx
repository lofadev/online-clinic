...
export const listDataApointment: PropsAppointment[] = [
  {
    ...
    children: (
      <ChildrenAppointment>
        usage.DataApointment.usage1.content
        <ContentChildren>
          <LinkStyle href="/path" target="blank">
            usage.DataApointment.usage1.link
          </LinkStyle>
          usage.DataApointment.usage1.desc
        </ContentChildren>
      </ChildrenAppointment>
    ),
  },
  {
    ...
    children: (
      <ChildrenAppointment>
        <ContentChildren>usage.DataApointment.usage2.content</ContentChildren>
      </ChildrenAppointment>
    ),
  },
  {
    ...
    children: (
      <ChildrenAppointment>
        <ContentChildren>usage.DataApointment.usage3.content</ContentChildren>
        <ContentChildren>usage.DataApointment.usage3.content2</ContentChildren>
      </ChildrenAppointment>
    ),
  },
  {
    ...
    children: (
      <ChildrenAppointment>
        <ContentChildren>usage.DataApointment.usage4.content</ContentChildren>
      </ChildrenAppointment>
    ),
  },
  {
    ...
    children: (
      <ChildrenAppointment>
        <ContentChildren>usage.DataApointment.usage5.content</ContentChildren>
        <ContentChildren>usage.DataApointment.usage5.content2</ContentChildren>
      </ChildrenAppointment>
    ),
  },
  {
    ...
    children: (
      <ChildrenAppointment>
        <ContentChildren>usage.DataApointment.usage6.content</ContentChildren>
      </ChildrenAppointment>
    ),
  },
  {
    ...
    children: (
      <ChildrenAppointment>
        <ContentChildren>usage.DataApointment.usage7.content</ContentChildren>
        <ContentChildren>usage.DataApointment.usage7.content2</ContentChildren>
      </ChildrenAppointment>
    ),
  },
];
...
export const listDataFlowDay: PropsAppointment[] = [
  {
    ...
    children: (
      <ChildrenAppointment>
        <ContentChildren> usage.dataFlowDay.flow1.content</ContentChildren>
        <ContentChildren>usage.dataFlowDay.flow1.content2</ContentChildren>
        <SubContent>usage.dataFlowDay.flow1.subContent</SubContent>
      </ChildrenAppointment>
    ),
  },
  {
    ...
    children: (
      <ChildrenAppointment>
        <ContentChildren>usage.dataFlowDay.flow2.content</ContentChildren>
        <ContentChildren>usage.dataFlowDay.flow2.content2</ContentChildren>
        <SubContent>usage.dataFlowDay.flow2.subContent</SubContent>
      </ChildrenAppointment>
    ),
  },
  {
    ...
    children: (
      <ChildrenAppointment>
        <ContentChildren>usage.dataFlowDay.flow3.content</ContentChildren>
        <ContentChildren>usage.dataFlowDay.flow3.content</ContentChildren>
      </ChildrenAppointment>
    ),
  },
...
export const listDataOrder: PropsAppointment[] = [
  {
    ...
    children: (
      <ChildrenAppointment>
        <ContentChildren>usage.dataOrder.order1.content</ContentChildren>
      </ChildrenAppointment>
    ),
  },
  {
    ...
    children: (
      <ChildrenAppointment>
        <ContentChildren>usage.dataOrder.order2.content</ContentChildren>
        <ContentChildren>usage.dataOrder.order2.content2</ContentChildren>
        <LinkChildren>
  ...
  },
  {
    ...
    children: (
      <ChildrenAppointment>
        <ContentChildren>usage.dataOrder.order3.content</ContentChildren>
        <ContentChildren>usage.dataOrder.order3.content2</ContentChildren>
      </ChildrenAppointment>
    ),
  },
  {
    ...
    children: (
      <ChildrenAppointment>
        <ContentChildren>usage.dataOrder.order4.content</ContentChildren>
        <SubContent>usage.dataOrder.order4.content2</SubContent>
      </ChildrenAppointment>
    ),
  },
];
